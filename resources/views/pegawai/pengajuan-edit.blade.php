<x-layout-pegawai>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/data-pengajuan/pengajuan-edit/' . $pengajuan->id_pengajuan . '/edit') }}"
                    method="POST">
                    @csrf
                    <h5 class="mb-3">Data Diri</h5>
                    <div class="row mb-3">
                        <label for="nm_penjual" class="col-sm-2 col-form-label">Nama Penjual</label>
                        <div class="col-sm-10">
                            <input type="text" name="nm_penjual"
                                class="form-control @error('nm_penjual') is-invalid @enderror" id="nm_penjual"
                                value="{{ old('nm_penjual', $pengajuan->nm_penjual) }}">
                            @error('nm_penjual')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat"
                                ...
                                value="{{ old('alamat', $pengajuan->alamat) }}">
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('merk') is-invalid @enderror"
                                name="merk" id="merk" value="{{ old('merk', $pengajuan->merk) }}" disabled>
                            @error('merk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('tipe') is-invalid @enderror"
                                name="tipe" id="tipe" value="{{ old('tipe', $pengajuan->tipe) }}" disabled>
                            @error('tipe')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('memory') is-invalid @enderror"
                                name="memory" id="memory" value="{{ old('memory', $pengajuan->memory) }}"
                                disabled>
                            @error('memory')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                name="harga" id="harga" value="{{ old('harga', $pengajuan->harga) }}"
                                disabled>
                            @error('harga')
                                <div class="invalid-feedback">
                                    {{ $message }}
                    ...
                    <div class="row mb-3">
                        <label for="status_pengajuan" class="col-2 col-form-label">Status pengajuan</label>
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default select example" name="status_pengajuan">
                                <option @if (old('status_pengajuan', $pengajuan->status_pengajuan) == 'Menunggu Konfirmasi') selected @endif value="Menunggu Konfirmasi">
                                    Menunggu Konfirmasi</option>
                                <option @if (old('status_pengajuan', $pengajuan->status_pengajuan) == 'Pengajuan Diterima') selected @endif value="Pengajuan Diterima">
                                    Pengajuan Diterima</option>
                                <option @if (old('status_pengajuan', $pengajuan->status_pengajuan) == 'Pengajuan Ditolak') selected @endif value="Pengajuan Ditolak">
                                    Pengajuan Ditolak</option>
                                <option @if (old('status_pengajuan', $pengajuan->status_pengajuan) == 'Driver Menuju Lokasi') selected @endif
                                    value="Driver Menuju Lokasi">
                                    Driver Menuju Lokasi</option>
                                <option @if (old('status_pengajuan', $pengajuan->status_pengajuan) == 'Pengajuan Selesai') selected @endif value="Pengajuan Selesai">
                                    Pengajuan Selesai</option>
                            </select>
                        </div>
                    </div>
                    <div class="mt-5">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#id_laptop').on('change', function() {
                    ...
                    $.getJSON('/data-pengajuan/get-data-laptop/' + LaptopId, function(data) {
                        $('#harga').empty();
                        $('#stok').empty();
