<x-layout-pegawai>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/data-antar/antar-edit/' . $data_pembelian->id_pembelian . '/edit') }}"
                    method="POST">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nm_pembeli"
                                ...
                                value="{{ old('nm_pembeli', $data_pembelian->nm_pembeli) }}" disabled>
                            @error('nm_pembeli')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="no_hp"
                                ...
                                value="{{ old('no_hp', $data_pembelian->no_hp) }}" disabled>
                            @error('no_hp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat"
                                ...
                                value="{{ old('alamat', $data_pembelian->alamat) }}" disabled>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mt-5">
                        <a href="/data-antar" class="btn btn-secondary">Kembali</a>
