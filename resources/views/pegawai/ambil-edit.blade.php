<x-layout-pegawai>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/data-ambil/ambil-edit/' . $pengajuan->id_pengajuan . '/edit') }}" method="POST">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nm_penjual"
                                ...
                                value="{{ old('nm_penjual', $pengajuan->nm_penjual) }}" disabled>
                            @error('nm_penjual')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="no_hp"
                                ...
                                value="{{ old('no_hp', $pengajuan->no_hp) }}" disabled>
                            @error('no_hp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="alamat"
                                ...
                                value="{{ old('alamat', $pengajuan->alamat) }}" disabled>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="mt-5">
                        <a href="/data-ambil" class="btn btn-secondary">Kembali</a>
