<x-layout-pegawai>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url('/data-user/user-edit/' . $user->id_user . '/edit') }}" method="POST">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="role">
                                ...
                                <option @if ($user->role == 'Pelanggan') selected @endif value="Pelanggan">Pelanggan
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nm_user') is-invalid @enderror"
                                name="nm_user" id="nm_user" value="{{ old('nm_user', $user->nm_user) }}">
                            @error('nm_user')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('alamat') is-invalid @enderror"
                                name="alamat" id="alamat" value="{{ old('alamat', $user->alamat) }}">
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
