...
<x-layouts>
    ...
    <main class="form-registration">
        <form action="/edit-akun" method="post">
            @csrf
            <h1 class="h3 mb-3 fw-normal text-center">Edit Data Akun</h1>
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('nm_user') is-invalid @enderror" id="nm_user"
                    name="nm_user" placeholder="John Doe" value="{{ old('nm_user', $data['nm_user']) }}" required>
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp"
                    name="no_hp" placeholder="085xxxx" value="{{ old('no_hp', $data['no_hp']) }}" required>
            ...
            <div class="form-floating mb-3">
                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                    name="email" placeholder="name@example.com" value="{{ old('email', $data['email']) }}" required>
            ...
            <button class="w-100 btn btn-lg btn-primary" type="submit">Simpan Perubahan</button>
        </form>
