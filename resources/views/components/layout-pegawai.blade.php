...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- My Own CSS-->
    <link rel="stylesheet" href="{{ asset('css/style-pegawai.css') }}">
...
<body class=" bg-body-secondary">
    ...
    <main class="container-fluid p-4 d-flex flex-row justify-content-end">
        {{ $slot }}
        <x-aside-pegawai></x-aside-pegawai>
    </main>
